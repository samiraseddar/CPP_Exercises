...
public:
    Monster(const std::string &_id, const std::string &_name2, Attribute _attribute, const std::string &_name3, int _atk, int _def) : Card{_id, CardType::Monster}, _attribute{_attribute}, _name3{_name3}, _atk{_atk}, _def{_def} { set_name(_name2); }
